 ...
 *
 * Responsibilities:
 * - Hides content behind a card-styled back face until revealed
 ...
 * - The back face matches card styling (bg-card) for a seamless flip
 */
	...
	return (
		...
		>
			...
			>
				...
				<div
					className="absolute inset-0 rounded-xl bg-card/60 shadow-xs ring-1 ring-foreground/10 backdrop-blur-md"
